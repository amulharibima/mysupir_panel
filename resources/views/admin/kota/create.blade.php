...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Masukkan data kota baru</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('admin/home')}}">Beranda</a></li>
              <li class="breadcrumb-item"><a href="{{url('admin/kota')}}">Kota </a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-navy">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="formAdd" role="form" method="POST" action="{{route('admin.kota.add')}}" enctype="multipart/form-data" data-parsley-validate>
                      @csrf
                      <div class="card-body">                      
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="nama" type="text" class="form-control" id="nama" placeholder="Masukkan Nama Kota" value="{{old('nama')}}" required>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="kode">Kode IATA</label>
                                <input name="kode" type="text" class="form-control" id="kode" placeholder="Masukkan Kode IATA" value="{{old('kode')}}" required>
                            </div>
                          </div>
