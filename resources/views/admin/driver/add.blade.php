...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Buat Supir Baru</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-navy">
                    <div class="card-header">
                        <h3 class="card-title">Form Tambah Supir</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="formAdd" role="form" method="POST" action="{{route('admin.supir.add')}}" enctype="multipart/form-data" data-parsley-validate>
                      @csrf
                      <div class="card-body">                      
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="nama" type="text" class="form-control" id="nama" placeholder="Masukkan Nama" value="{{old('nama')}}" required>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Masukkan Email" value="{{old('email')}}" required>
                            </div>  
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">                              
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="phone_number" id="phone_number" value="{{old('phone_number')}}" data-inputmask="'mask' : '(+62) 899-9999-99[9][9][9]'" placeholder="(+62) 8__-____-____" data-parsley-pattern="^[(][+]62[)]\s8\d\d?-\d\d\d\d?-\d{2,5}$" data-parsley-pattern-message="Your phone number must be at least 10 characters long." required>
