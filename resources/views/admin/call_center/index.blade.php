...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Call Center</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3">
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th>Nomor Telepon Call Center</th>
                                    <th>Action</th>
                                </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <form method="post">
                                            @csrf
                                            <td>
                                                <input required class="form-control" type="number" name="call_center" value="{{$call_center->call_center}}">
                                            </td>
                                            <td>
