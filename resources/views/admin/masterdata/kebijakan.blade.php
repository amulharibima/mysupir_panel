...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Kebijakan dan Privasi</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header border-transparent">
                            <h3 class="card-title">Kebijakan dan Privasi</h3>

                            <div class="card-tools">
                                <a href="{{url('/admin/masterdata/create-kebijakan')}}" class="fa fa-plus" style="margin-right: 30px"> Create</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('/admin/masterdata/edit-kebijakan')}}" class="btn btn-sm btn-info float-left">Edit</a>&nbsp;&nbsp;&nbsp;
