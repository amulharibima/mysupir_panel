...
@section('title', 'Tambah Syarat dan Ketentuan')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Buat Syarat dan Ketentuan Baru</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah Syarat dan Ketentuan</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form">
