...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Harga</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3">
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th>Harga per KM (Rp)</th>
                                    <th>Harga Default (Rp)</th>
                                    <th>Action</th>
                                </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <form method="post">
                                            @csrf
                                            <td>
                                                <input required class="form-control" type="number" name="price_per_km" value="{{$price->price_per_km}}">
                                            </td>
                                            <td>
                                                <input required class="form-control" type="number" name="default_price" value="{{$price->default_price}}">
                                            </td>
                                            <td>
